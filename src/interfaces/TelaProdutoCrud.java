...
public class TelaProdutoCrud{
	...
	public static void menuTelaProduto() {
	...
	public static void cadastrarProduto() {
		...
		Produto p = new Produto(id, nome, precoCusto, precoVenda);

		if (CatalogoProdutos.cadastrar(p)) {
			System.out.println("=".repeat(18)+"[PRODUTO] Cadastrado com sucesso"+"=".repeat(18));
		} else {
			System.out.println("=".repeat(18)+"[PRODUTO] Já existe um produto com esse ID"+"=".repeat(18));
		}
	}
